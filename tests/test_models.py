...
def test_daily_max_positive_int():
...
def test_daily_max_negative_int():
    """Test that max function works for an array containing negatives."""
    test_input = np.array([[-4, -2], [-1, 6], [4, -9]])
